  ...
  <xsl:template match="/">
    ...
    <body>
      ...
      <blockquote>
        ...
        <p>You can add the current address in any supported reader to subscribe to this
    content and get the latest content updates in time.</p>
        <p>
